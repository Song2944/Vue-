<template>
  <div class="home-box">
  	<header-block title="DIY商城"> </header-block>
  	<div>
...
export default {
  data () {
    return {
      imglist: [{src:"//img.alicdn.com/tfs/TB1yEsqelLoK1RjSZFuXXXn0XXa-520-280.png_q90_.webp",name:"新品"}],
      ...
      {id:741852,imgsrc:'https://gd1.alicdn.com/imgextra/i4/433670747/TB2iZdejQKWBuNjy1zjXXcOypXa_!!433670747.jpg_400x400.jpg_.webp',title:'山东威海大樱桃',standard:'规格:500g',favorable_price:129,price:'159'},
